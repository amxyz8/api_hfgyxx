...
class QuestionOption extends BaseServices
{
    public $model = null;

    public function __construct()
    {
        $this->model = new QuestionOptionModel();
    }
     ...
     * @return array
     */
    public function getPaginateList($qid, $pid, $num = 10)
    {
        try {
            $list = $this->model->getPaginateList($qid, $pid, $field = '*', $num);
            $result = $list->toArray();
        } catch (\Exception $e) {
